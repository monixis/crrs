		...
		<div class= "content_container">
			<div class = "container_home_child" >
				...
				<div class= "content" style="width:630px;">
					...
					<p class="infoHeading"> Thank You. Your reservation has been made! </p><br>
					<button id="resButton" onclick="location.href='<?php echo base_url(""); ?>'">Home</button>
					<button id="resButton" onclick="location.href='<?php echo base_url("?c=crr&m=reserveform"); ?>'">Reserve Form</button>
